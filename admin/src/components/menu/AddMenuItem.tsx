...
const AddMenuItem = () => {
  ...
  return (
    <SheetContent className="dark:border-l border-gray-700 pt-10 overflow-y-auto scrollbar scrollbar-w-0 ">
      <SheetHeader>
        <SheetTitle className="text-2xl">Add a new Menu Item</SheetTitle>
      </SheetHeader>
      <SheetDescription>Add a new item to your menu.</SheetDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Rs 50" {...field} type="number" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
